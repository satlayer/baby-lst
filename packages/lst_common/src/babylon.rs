...
use cosmwasm_std::{Addr, Api, Binary, BlockInfo, Coin, CosmosMsg, CustomMsg, CustomQuery, Empty, Event, Querier, StakingMsg, StakingQuery, Storage, Uint128};
use cw_multi_test::error::AnyResult;
use cw_multi_test::{AppResponse, CosmosRouter, Executor, Module, StakingSudo};
...
pub trait EpochingModule: Module<ExecT = EpochingMsg, QueryT = EpochingQuery, SudoT = Empty> {
